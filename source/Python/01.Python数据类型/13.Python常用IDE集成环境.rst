...
卸载库文件 pip uninstall libname

检查第三方库是否正确安装 [root@pxe-server ~]# python Python 2.7.5
(default, Oct 30 2018, 23:45:53) [GCC 4.8.5 20150623 (Red Hat 4.8.5-36)]
on linux2 Type "help", "copyright", "credits" or "license" for more
information. >>> import paramiko >>>
...
1. pip install redis -i https://pypi.douban.com/simple -i：指定镜像地址
   　 2.配置好环境变量后cmd输入 python -m pip --default-timeout=100
   install 库名称 -i http://pypi.douban.com/simple/ --trusted-host
   pypi.douban.com

3.python.exe改名版 python3 -m pip --default-timeout=100 install 库名称
...
-  
   ...
   (2) Installing from PyPI using easy\_install:
...
.. figure:: ../../_static/jupyter-python.png
   :alt: 

为Jupyter Notebook添加目录
~~~~~~~~~~~~~~~~~~~~~~~~~~

①： 在Windows搜索框中输入Anaconda Prompt并单击打开. |image0|

②：

``输入 pip install jupyter_contrib_nbextensions`` 然后按 Enter
键运行，安装jupyter\_contrib\_nbextensions模块
...
按下图右上角方框内的按钮，目录就会显示出来了，如下图所示。 |image2|
...
.. |image0| image:: ../../_static/Ancona00001.png
.. |image1| image:: ../../_static/ancode0002.png
.. |image2| image:: ../../_static/ancode00003.png
