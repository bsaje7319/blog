...
.. figure:: ../../_static/unittest00001.png
   :alt: 

.. figure:: ../../_static/unittest0002.png
   :alt: 

.. figure:: ../../_static/unittest0003.png
   :alt: 
...
程序会在运行每个测试用例(以test\_开头的方法)之前自动执行setUp()方法来初始化测试固件，
并在每个测试用例(以test\_开头的方法)运行完成之后自动执行tearDown()方法来销毁测试固件。
